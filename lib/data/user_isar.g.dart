...
extension UserIsarByIndex on IsarCollection<UserIsar> {
  Future<UserIsar?> getByEmail(String email) {
    return getByIndex(r'email', [email]);
  }

  UserIsar? getByEmailSync(String email) {
  ...
  Future<List<UserIsar?>> getAllByEmail(List<String> emailValues) {
    final values = emailValues.map((e) => [e]).toList();
    return getAllByIndex(r'email', values);
  }

  List<UserIsar?> getAllByEmailSync(List<String> emailValues) {
    final values = emailValues.map((e) => [e]).toList();
  ...
  Future<Id> putByEmail(UserIsar object) {
    return putByIndex(r'email', object);
  }

  Id putByEmailSync(UserIsar object, {bool saveLinks = true}) {
    return putByIndexSync(r'email', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByEmail(List<UserIsar> objects) {
    return putAllByIndex(r'email', objects);
  }

  List<Id> putAllByEmailSync(List<UserIsar> objects, {bool saveLinks = true}) {
...
extension UserIsarQueryWhere on QueryBuilder<UserIsar, UserIsar, QWhereClause> {
  ...
  QueryBuilder<UserIsar, UserIsar, QAfterWhereClause> emailEqualTo(
      String email) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserIsar, UserIsar, QAfterWhereClause> emailNotEqualTo(
      String email) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension UserIsarQueryFilter
  ...
  QueryBuilder<UserIsar, UserIsar, QAfterFilterCondition> passwordHashEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserIsar, UserIsar, QAfterFilterCondition> passwordHashLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<UserIsar, UserIsar, QAfterFilterCondition> passwordHashBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<UserIsar, UserIsar, QAfterFilterCondition> passwordHashEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserIsar, UserIsar, QAfterFilterCondition> passwordHashContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<UserIsar, UserIsar, QAfterFilterCondition> passwordHashMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
...
extension UserIsarQuerySortBy on QueryBuilder<UserIsar, UserIsar, QSortBy> {
  ...
  QueryBuilder<UserIsar, UserIsar, QAfterSortBy> sortByPasswordHash() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'passwordHash', Sort.asc);
    });
  }

  QueryBuilder<UserIsar, UserIsar, QAfterSortBy> sortByPasswordHashDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension UserIsarQuerySortThenBy
  ...
  QueryBuilder<UserIsar, UserIsar, QAfterSortBy> thenByPasswordHash() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'passwordHash', Sort.asc);
    });
  }

  QueryBuilder<UserIsar, UserIsar, QAfterSortBy> thenByPasswordHashDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'passwordHash', Sort.desc);
    });
  }
...
extension UserIsarQueryWhereDistinct
  ...
  QueryBuilder<UserIsar, UserIsar, QDistinct> distinctByPasswordHash(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension UserIsarQueryProperty
  ...
  QueryBuilder<UserIsar, String, QQueryOperations> passwordHashProperty() {
    return QueryBuilder.apply(this, (query) {
